...
public class testErrorMsg1 {
	...
	public static void main(String[] args) throws Exception {
		...
		//校验不对
		String str35 = "FA F5 1B 80 7C 35 00 00 00 00 01 01 55 00 00 00 00 FF 66 00 00 00 00 FF 77 00 00 00 0 FF 66";
		byte[] b35 = CommFunction.hexString2ToBytes(str35);
		bootstrap.getSocketChannel().writeAndFlush(b35); 
		
		TimeUnit.SECONDS.sleep(2);
		//长度不对 多一位
		String str58 = "FA F5 09 80 D4 58 00 00 00 00 D4 00 00 2C";
