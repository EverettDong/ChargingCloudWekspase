...
public class ArraysN {
	...
	public static void copy(byte[] destArray, int ind1, byte[] srcArray, int ind2, int len)
	...
	public static void copy(byte[] destArray, int ind1, byte[] srcArray) throws IndexOutOfBoundsException {
		copy(destArray, ind1, srcArray, 0, srcArray.length);
	}

	public static void copy(byte[] destArray, byte[] srcArray, int ind2, int len) throws IndexOutOfBoundsException {
	...
	public static boolean compare(byte[] array1, int ind1, int len1, byte[] array2, int ind2, int len2) {
	...
	public static boolean compare(byte[] array1, int len1, byte[] array2, int len2) {
